...
contract Limiter is Ownable {
    ...
    event MaxBuyChange(uint256 value);
    event MaxSellChange(uint256 value);
    event LimitBuyChange(uint256 value);
